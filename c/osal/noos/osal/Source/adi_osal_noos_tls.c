/* $Revision: 31504 $
 * $Date: 2015-06-19 17:57:27 +0800 (Fri, 19 Jun 2015) $
******************************************************************************
...
#elif defined (__ICCARM__) && defined(NDEBUG)
/* if we add this pragma when optimization is other than medium/high
 * we get a warning and the inline does not happen
 */
